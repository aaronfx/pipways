                ...
                return filtered.map(function(p, i) {
                    ...
                    var imgHero = p.featured_image
                        ? '<img src="' + p.featured_image + '" class="w-full h-56 lg:h-full object-cover group-hover:scale-105 transition-transform duration-500"'
                          + ' onerror="this.src=\'\';this.style.display=\'none\';this.parentElement.innerHTML=\'<div style=\"height:100%;min-height:14rem;background:linear-gradient(135deg,#1e1b4b,#1a1040,#0f172a);display:flex;align-items:center;justify-content:center;\"><i class=\"fas fa-newspaper\" style=\"font-size:3rem;color:rgba(255,255,255,.07)\"></i></div>\'">'
