...
_QUIZ_DATA = [
    ...
    ("The 1-2% Rule", "With a $5,000 account using 2% risk and a 50-pip stop on EUR/USD, what is the correct lot size?", "1.0 standard lot", "0.2 mini lots", "5.0 micro lots", "0.02 standard lots", "B", "$5,000 × 2% = $100 risk. $100 ÷ 50 pips ÷ $1/pip per mini lot = 2 mini lots. 0.2 standard = 2 mini lots.", "risk_management"),
    ("Stop Loss and Take Profit", "What is the minimum risk-to-reward ratio professionals recommend?", "1:1", "1:2", "1:3", "2:1", "B", "A 1:2 R:R means you risk $1 to make $2. This means you only need to win 35-40% of trades to be profitable over time.", "risk_reward"),
    ...
    ("MACD and RSI", "RSI divergence occurs when:", "Price and RSI both make new highs", "Price makes a new high but RSI makes a lower high", "RSI goes above 70", "Price and RSI both go below 30", "B", "Bullish divergence: price new low, RSI higher low. Bearish divergence: price new high, RSI lower high. Divergence signals momentum is weakening before price confirms the reversal.", "indicators"),
