...
try:
    from routes import auth, signals, courses, blog, media, webinars
...
upload_dirs = ["uploads", "uploads/blog", "uploads/courses", "uploads/signals", "uploads/avatars", "uploads/webinars"]
...
async def root():
    """API root with HTML documentation link"""
    return """
    <!DOCTYPE html>
    <html>
    <head>
