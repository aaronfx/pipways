"""
LMS Auto-Initialisation — Enhanced Trading Academy Edition v3.0
=============================================
Adds user_badges table, enhanced curriculum, and Trading Academy tables.
Every statement is idempotent. Runs at startup via main.py lifespan.
"""
...
# CMS LMS Tables (existing system - do not modify)
_TABLE_SQLS = [
    """
...
# ══════════════════════════════════════════════════════════════════════════════
# TRADING ACADEMY TABLES (Enhanced with Badges System)
# ══════════════════════════════════════════════════════════════════════════════
...
_LEARNING_TABLE_SQLS = [
    ...
    """,
    # NEW: Badge system for achievements
    """
...
_MODULES = [
    ...
    # INTERMEDIATE LEVEL (7 modules) - indices 8-14
    ...
    # ADVANCED LEVEL (7 modules) - indices 15-21
    ...
    (3, "Professional Trading Execution",     "Advanced order types, execution algorithms, and institutional platforms.", 7),
]

# Enhanced lesson content with professional structure
_LESSONS = [
    # ═════════════════════════════════════════════════════════════════════════
